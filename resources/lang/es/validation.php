	...
	'custom' => [
		...
		*/
		...
		'merchant_id' => [
			...
			'enable' => $responseCodes->responseList('2', '202'),
		],
		...
		'reader_name' => [
			'required' => $responseCodes->responseList('1', '104'),
		],

		'branch' => [
			'required' => $responseCodes->responseList('1', '105'),
		],

		'trx_type' => [
			'required' => $responseCodes->responseList('1', '106'),
		],

		'secret_key' => [
			'required' => $responseCodes->responseList('1', '107'),
		],

		'timestamp' => [
			'required' => $responseCodes->responseList('1', '108'),
		],

		'reader_ip' => [
			'required' => $responseCodes->responseList('1', '109'),
		],

		'access_token' => [
			'required' => $responseCodes->responseList('1', '110'),
		],
